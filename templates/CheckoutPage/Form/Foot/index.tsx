...
const Foot = ({}: FootProps) => (
  <div className="">
    <div className="flex items-center mb-6 caption1 text-n-4/50">
      ...
      Secured form with Star Astro
    </div>
    <div className="text-right">
      <div className="h4">Billed now: $</div>
      <button
      ...
      <div className="max-w-[27rem] ml-auto mb-4 caption1 text-n-4/50 dark:text-n-4/75">
        By clicking &quot;Start Star Astro Enterprise plan&quot;, you agree to
        be charged $399 every month, unless you cancel.
      </div>
      {/* <button className="btn-blue" type="submit">
                Start Star Astro Enterprise plan
            </button> */}
