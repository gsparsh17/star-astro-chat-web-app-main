...
const Notifications = ({ items }: NotificationsProps) => {
  ...
  return (
    <>
      <div className="relative z-10 mr-6 lg:mr-4">
        <Menu>
          {({ close }) => (
            <>
              <Menu.Button className="group relative w-6 h-6">
                <Image
      ...
      >
        <Settings items={settings} activeItem={2} setVisibleSettings={setVisibleSettings}/>
      </Modal>
    </>
  )
}
